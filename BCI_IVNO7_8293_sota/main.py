...
class ExGAN():
    def __init__(self, args, nsub, fold):
        ...
        self.model = QuantGate(emb_size=1770, depth=6, bottleneck_dim=128, n_classes=2).float().to(self.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_epochs', type=int, default=15, help="fixed pre-training epochs")
    ...
    parser.add_argument('--file_path', type=str, default=r"E:\Research\EEGDataSet\BNCI20140mi1\saved_loso_window_logmap_gfk", help="Path from the current dataset")
