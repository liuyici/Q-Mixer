...
class ExGAN():
    def __init__(self, args, nsub, fold):
        ...
        self.model = QuantGate(emb_size=120, depth=6, bottleneck_dim=128, n_classes=2).float().cuda()
    ...
    def get_source_data(self, feature="de_LDS"):
        if self.args.dataset == "seed":
            datasets, dataset_test, X_subjects, Y_subjects = load_mi1(args, path=r"E:/Research/EEGDataSet/BNCI2014002/feature", n_windows=args.window_size, k=25)
